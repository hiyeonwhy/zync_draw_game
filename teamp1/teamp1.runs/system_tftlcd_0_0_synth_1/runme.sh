...
HD_PWD='C:/work/teamp1/teamp1.runs/system_tftlcd_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_tftlcd_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_tftlcd_0_0.tcl
