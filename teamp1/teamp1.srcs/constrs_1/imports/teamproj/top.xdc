...
## Button Inputs
set_property IOSTANDARD "LVCMOS33" [get_ports "Right_0"]
set_property PACKAGE_PIN "Y18" [get_ports "Right_0"]

set_property IOSTANDARD "LVCMOS33" [get_ports "Down_0"]
...
set_property IOSTANDARD "LVCMOS33" [get_ports "Left_0"]
